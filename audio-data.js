...
const NARRATION_OVERRIDES = {
  ...
  's-mod2':
    'Módulo 2. Conhecendo o Equipamento. Neste módulo você aprenderá sobre tipos de transpaleteiras, capacidades técnicas, componentes principais, painel de controle e o funcionamento do timão.',
  s3a:
  ...
  's-mod4':
    'Módulo 4. Movimentação, Cargas e Armazenamento. Neste módulo você aprenderá sobre estabilidade da carga, transporte em rampas, tipos de paletes e as regras de empilhamento e solo.',
  s4v:
  ...
  's-mod5':
    'Módulo 5. Manutenção e Segurança com Baterias. Neste módulo você aprenderá sobre manutenção preventiva, troca de bateria, gestão da recarga e riscos químicos.',
  s5v:
  ...
  's-mod6':
    'Módulo 6. Gestão de Riscos, Emergências e EPIs. Neste módulo você aprenderá sobre equipamentos de proteção individual, principais riscos de acidente, ações em emergência e proibições críticas.',
  s6v:
  ...
  s_end:
    'Treinamento Concluído! Parabéns, você finalizou com sucesso todas as etapas deste treinamento de NR11 - OPERADOR DE TRANSPALETEIRA. Obrigado pela sua atenção e lembre-se sempre de priorizar a segurança integrada e os procedimentos corretos em todas as suas atividades industriais!',
};
